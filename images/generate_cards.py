...
CARD_SCENES: dict[str, str] = {
    ...
    "mp-neural-firewall": "A figure sitting cross-legged in meditation, surrounded by a glowing geometric shield. Outside the shield, dark tendrils of code and ghostly advertisements probe for entry points, recoiling when they touch the barrier. The figure strains with concentration as one tendril finds a hairline crack.",
    ...
    "mp-brain-defrag": "A person reclined in a futuristic chair wearing a helmet covered in blinking lights. Tiny mechanical arms visible through a glass panel sort glowing orbs — each orb a memory. A bin beside the chair holds discarded dim orbs. One discarded orb still pulses faintly — it was important.",
    ...
    "mp-merge-regret": "A person staring at their reflection in a mirror, one side of their face covered in chrome panels and wires. Their hands hover near the panels, wanting to remove them but unable. A consultation form on the table is stamped 'PERMANENT.' A photo on the wall shows them before — unmodified, smiling.",
    ...
    "sp-compost-influencer": "A person in spotless designer clothes holding a phone, filming a compost bin with exaggerated enthusiasm. The actual gardener stands behind them, arms crossed, unimpressed. The phone screen shows a rising follower count. Pristine manicured hands have clearly never touched soil.",
    ...
    "gz-panopticon-tourist": "A cheerful tourist in a Hawaiian shirt posing for a photo next to a tall pole covered in security cameras, giving a thumbs up. Other visitors in the background also pose with cameras. A gift shop nearby displays miniature camera replicas as souvenirs on a spinning rack.",
